-- Create database for Dapper project
USE master;
GO

IF EXISTS (SELECT name FROM sys.databases WHERE name = 'ORMComparisonDapper')
BEGIN
    ALTER DATABASE ORMComparisonDapper SET SINGLE_USER WITH ROLLBACK IMMEDIATE;
    DROP DATABASE ORMComparisonDapper;
END
GO

CREATE DATABASE ORMComparisonDapper;
GO

USE ORMComparisonDapper;
GO
